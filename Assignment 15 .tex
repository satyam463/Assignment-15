...
\end{align}
consider $\beta^{'}$ under T
\begin{align}
    T\brak{\vec{\alpha_1}}=\myvec{1&0\\0&0}\myvec{1\\i}=\myvec{1\\0}\\
    T\brak{\vec{\alpha_2}}=\myvec{1&0\\0&0}\myvec{-i\\2}=\myvec{-i\\0}
\end{align}
 we have to write $T\brak{\vec{\alpha_1}}$  and $T\brak{\vec{\alpha_2}}$  as linear combinations of $e_1$ , $e_2$
 \begin{align}
     T\brak{\vec{\alpha_1}}= 1 e_1 + 0 e_2 \\
      T\brak{\vec{\alpha_2}}= -i e_1 + 0 e_2
 \end{align}
 Therefore matrix of relative to the pair $\beta^{'}$ , $\beta$  
 \begin{align}
  T\brak{\vec{\beta^{'}}}=\myvec{1&-i\\0&0}\vec{\beta}   
 \end{align}
\end{document}
